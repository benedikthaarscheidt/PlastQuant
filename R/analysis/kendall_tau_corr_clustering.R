...
# ======================= CONFIG =======================
in_dir  <- "~/CRC_1644_Z2_GWAS_simple/rank_flops"
...
sumstats_path_override <-
  "~/CRC_1644_Z2_GWAS_simple/R-files/regression_summary_stats/regression_data_full_interval_15_indices_1_16_31_46_50.csv"
